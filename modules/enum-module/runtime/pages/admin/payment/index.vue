...
import pConfig from "../../../assets/configs/admin-payment-list.json";
import type { IEnumItem } from "../../../types/enum.types";

definePageMeta({
  layout: "admin",
  syscode: "admin_payment",
...
<template>
  <div v-if="config" :id="config.syscode" class="w-full max-w-7xl mx-auto px-5">
    ...
    <div class="flex justify-end gap-2">
      ...
      />
      <UButton
        :to="localePath(routes.admin_payment_create?.path!)"
    ...
    <CmpTable
      ...
      :config="config"
      :data="payments?.data as IEnumItem[]"
      :meta="meta"
      :loading="loading"
      @delete="isOpen = true"
      @sort="handleSort"

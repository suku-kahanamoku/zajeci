...
import aConfig from "../../../assets/configs/admin-address-create.json";

definePageMeta({
  layout: "admin",
  syscode: "admin_address_create",
  title: "$.address.admin.create.title",
});
...
const { config, loading, onCreate } = useAddressAdmin(aConfig);
